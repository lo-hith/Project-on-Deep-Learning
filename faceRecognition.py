...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('E:\ppts\deep learning\FaceRecognition-master\FaceRecognition-master\HaarCascade\haarcascade_frontalface_default.xml')#Load haar classifier
